        ...
        <nav className={styles.Social}>
            <ul className={styles.SocialList}>
                {networksList.map(item => (
                    <li className={styles.SocialListItem}><a className={styles.SocialListItemLink} href={item.path}><img className={styles.SocialListItemLinkIcon} src={item.icon} alt={item.name}/>{item.name}</a></li>
                ))}
            </ul>
        </nav>
    );
